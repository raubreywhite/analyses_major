...
d1 <- readxl::read_excel(file.path(RAWmisc::PROJ$RAW,
                                    ...
                                    "Gaza - Staff in PNIPH but not in MoH as of 04 Feb 2018.xlsx"))
...
d3 <- readxl::read_excel(file.path(RAWmisc::PROJ$RAW,
                                    "Workers records to be removed",
                                    "need to be removed - makassed.xlsx"))
...
TO_REMOVE <- unique(c(d1$`error ID`,d2$HR01,d3$HR01,d4$`ID number`,d5$HR01))
length(TO_REMOVE)
