...
d4 <- readxl::read_excel(file.path(RAWmisc::PROJ$RAW,
                                    "Workers records to be removed",
                                    "to remove.xlsx"))
d5 <- readxl::read_excel(file.path(RAWmisc::PROJ$RAW,
                                    "Workers records to be removed",
...
if(EXTRA_8000){
  dFacilities <- data.table(rbind(d1,d2,d3[names(d1)],d4[names(d1)],d5[names(d1)]))
} else {
...
d5 <- haven::read_spss(file.path(RAWmisc::PROJ$RAW,
                                    "New 8,000 records for data importing-received from Fayez",
                                    "worker_main (6).sav"))
...
if(EXTRA_8000){
  dWorkers <- data.table(rbind(d1,d2,d3,d4,d5))
} else {
...
if(EXTRA_8000){
  masterdED03 <- dED03 <- data.table(rbind(d1,d2,d3[names(d1)],d4[names(d1)],d5[names(d1)]))
} else {
