...
dWorkers[,isAreaC:=as.numeric(NA)]
dWorkers[,isJordanValley:=as.numeric(NA)]
dWorkers[,isJerusalem:=as.numeric(NA)]

dWorkers[RE02==1,isAreaC:=1]
dWorkers[RE01==1,isJordanValley:=1]
dWorkers[IDH03 %in% dLocation[district=="East Jerusalem (J1)"]$localityCode, isJerusalem:=1]
...
stack <- data.table(expand.grid(prof=c(
  ...
  "isProf_Psychiatrist",
  "isProf_Pharmacist"
  ),dist=districtNames,stringsAsFactors = F))
