...
SHARED_TODAY <- file.path(RAWmisc::PROJ$SHARED_TODAY,extraDir)
...
updatedCW00xx <- data.table(readxl::read_excel(file.path(RAWmisc::PROJ$RAW,
                                    "data_richard",
...
updatedCW00xxx <- data.table(readxl::read_excel(file.path(RAWmisc::PROJ$RAW,
                                    "data_richard",
...
dxxx2 <- d5 <- haven::read_spss(file.path(RAWmisc::PROJ$RAW,
                                    "New 8,000 records for data importing-received from Fayez",
                                    "worker_main (6).sav"))
d6 <- readxl::read_excel(file.path(RAWmisc::PROJ$RAW,
                                   "data_richard",
...
changeHR03 <- data.table(readxl::read_excel(file.path(RAWmisc::PROJ$RAW,"data_richard","2018-09-12_conflicing_ages_overwrite.xlsx")))
...
openxlsx::write.xlsx(dMOHMaster[ID %in% final$MOH_ONLY],file.path(SHARED_TODAY,"VALIDATING MoH West Bank official list_DATASET_THAT_EXISTS_IN_MOH_LIST_BUT_NOT_SYSTEM.xlsx"))
