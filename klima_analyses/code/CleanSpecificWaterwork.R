CleanWP1SpecificWaterWork <- function(fileIn, fileOut,
  ...
  saveRDS(d, file.path(RPROJ$PROJCLEAN,"WP1_waterworks",fileOut))
...
CleanWP1SpecificWaterWorkLongOppegard <- function(fileIn=file.path(RPROJ$PROJRAW,"WP1_waterworks/Oppegård/Rådata/aggregated.xlsx"),
